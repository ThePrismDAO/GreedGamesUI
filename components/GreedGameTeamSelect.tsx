...
const GreedGameTeamSelect = ({setGameStatus, library, account, tokens, numTokensOwned, tokenAPIUri}) => {
    ...
    const Complete = () => <span className=''>The 3rd Greed Games have begun! <a href="#" onClick={() => setGameStatus("ViewBracket")}>View Bracket</a></span>
            ...
            <div className="team">
                <div className="portraits-title">YOUR TEAM 
                    <div className="float-right py-30 relative"> 
                        <div className='register-countdown'><b><Countdown date={new Date(1656660597 * 1000)} ><Complete /></Countdown></b> until the <span className='text-black-400 font-bold'>Third Greed Games</span>!</div>
