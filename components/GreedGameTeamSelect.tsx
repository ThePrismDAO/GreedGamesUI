            ...
            <div className="team">
                <div className="portraits-title">YOUR TEAM 
                    <div className="float-right py-30 relative">
                        <div className='register-countdown'><b><Countdown date={new Date(1651363200 * 1000)} /></b> until the <span className='text-black-400 font-bold'>First Greed Games</span>!</div>
