...
const GreedGameTeamSelect = ({setGameStatus, library, account, tokens, numTokensOwned, tokenAPIUri}) => {
    ...
    const Complete = () => <span className=''>The Greed Games have begun! <a href="#" onClick={() => setGameStatus("ViewBracket")}>View Bracket</a></span>
            ...
            <div className="team">
                <div className="portraits-title">YOUR TEAM 
                    <div className="float-right py-30 relative">
                        <div className='register-countdown'><b><Countdown date={new Date(1651363200 * 1000)} ><Complete /></Countdown></b> until the <span className='text-black-400 font-bold'>First Greed Games</span>!</div>
